...
namespace SqlViewer.Models.Logging
{
    ...
    public class DbLogWriter : ILoggingWriter
    {
        ...
        public void WriteLog(string msg)
        {
            ...
            {
                string sqlRequest = System.IO.File.ReadAllText(System.IO.Path.Combine(SettingsHelper.GetRootFolder(), "dbconnections/Queries/Sqlite/App/InsertIntoDbgLog.sql")); 
