...
namespace SqlViewer.Models.AppBranches
{
    ...
    public class MainDbBranch
    {
        ...
        public MainDbBranch()
        {
            DbConnectionPreproc = new DbConnectionPreproc(); 
            DatabasePreproc = new DatabasePreproc(this); 
            TablePreproc = new TablePreproc(this); 
            RequestPreproc = new RequestPreproc(this); 
            CenterDbPreprocFactory = new CenterDbPreprocFactory(this); 
        }
