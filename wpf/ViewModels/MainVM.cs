...
namespace SqlViewer.ViewModels
{
    ...
    public class MainVM
    {
        ...
        /// </summary>
        public CoreBranch CoreBranch { get; private set; } 
        /// <summary>
        ...
        public MainVM(MainWindow mainWindow)
        {
            ...
            this.CoreBranch = new CoreBranch(); 
            this.VisualVM = new VisualVM(this); 
            this.AppMainCommand = new AppMainCommand(this); 
            (this.Translator = new Translator(this)).SetAppDbConnection((SqlViewerDatabase.DbConnections.SqliteDbConnection)this.CoreBranch.MainDbBranch.GetAppDbConnection()); 
        ...
        public void InitAppRepository()
        {
            try
            {
                ...
                DataTable dt = this.CoreBranch.MainDbBranch.RequestPreproc.SendSqlRequestA(this.CoreBranch.MainDbBranch.RequestPreproc.GetSqlRequestFromFile("Sqlite/App/SelectFromSettings.sql")); 
                ...
                this.CoreBranch.MainDbBranch.DbConnectionPreproc.InitUserDbConnection(); 
        ...
        public void RecoverSettings()
        {
            ...
            if (System.Windows.MessageBox.Show(msg, "Recover settings", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
                ...
                string sql = this.CoreBranch.MainDbBranch.RequestPreproc.GetSqlRequestFromFile("Sqlite/App/RecoverSettings.sql"); 
                this.CoreBranch.MainDbBranch.RequestPreproc.SendSqlRequestA(sql); 
                InitAppRepository(); 
                Translate(); 
        ...
        public void SaveSettings()
        {
            ...
            if (System.Windows.MessageBox.Show(msg, "Save settings", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
                try 
                {
                    ...
                    string sql = this.CoreBranch.MainDbBranch.RequestPreproc.GetSqlRequestFromFile("Sqlite/App/UpdateSettingsEditor.sql"); 
                    ...
                    sql = this.CoreBranch.MainDbBranch.RequestPreproc.GetSqlRequestFromFile("Sqlite/App/UpdateSettingsDb.sql"); 
        ...
        private void PreprocDbCommand(string parameter)
        {
            ...
            switch (parameter)
            {
                case nameof(DbCommandEnum.SendSql):
                    var result = this.CoreBranch.MainDbBranch.RequestPreproc.SendSqlRequestU(this.MainWindow.SqlPage.mtbSqlRequest.Text); 
                    this.VisualVM.DisplaySqlResult(result); 
                    break;
                    
                case nameof(DbCommandEnum.New):
                    this.CoreBranch.MainDbBranch.DatabasePreproc.CreateDb(); 
                    break;
                    
                case nameof(DbCommandEnum.Open):
                    this.CoreBranch.MainDbBranch.DatabasePreproc.OpenDb(); 
                    this.VisualVM.DisplayActiveDb(); 
                    this.VisualVM.DisplayTablesInActiveDb(); 
                    break;
