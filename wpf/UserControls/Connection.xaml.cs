...
namespace SqlViewer.UserControls
{
    ...
    public partial class Connection : UserControl
    {
        ...
        private void btnConnectionExecute_Clicked(object sender, System.EventArgs e)
        {
            try
            {
                var di = this.MainVM.CoreBranch.InterDbBranch.DbInterconnection; 
        ...
        private void TransferData(string tableName)
        {
            try
            {
                ...
                ICommonDbConnectionSV dbConnection = OrdinalNum == 1 ? this.MainVM.CoreBranch.InterDbBranch.DbInterconnection.InterDbConnection2 : this.MainVM.CoreBranch.InterDbBranch.DbInterconnection.InterDbConnection1; 
