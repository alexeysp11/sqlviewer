...
namespace SqlViewer.UserControls
{
    ...
    public partial class Menu : UserControl
    {
        ...
        private void InitFile()
        {
            ...
            miFileNewFunction.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileNewProcedure.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileNewTest.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileNewTable.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileNewSequence.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileNewView.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileNewTrigger.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileOpenFunction.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileOpenProcedure.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileOpenTest.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miFileOpenTable.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileOpenSequence.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileOpenView.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
            ...
            miFileOpenTrigger.IsEnabled = string.IsNullOrEmpty(RepoHelper.AppSettingsRepo.DatabaseSettings.DbName) ? false : true;
        ...
        private void InitPages()
        {
            ...
            miPagesFunctions.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miPagesProcedures.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miPagesTests.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
            ...
            miPagesDatabases.IsEnabled = RepoHelper.AppSettingsRepo.DatabaseSettings.ActiveRdbms == RdbmsEnum.SQLite ? false : true;
