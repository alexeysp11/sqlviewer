...
namespace SqlViewer.Views
{
    ...
    public partial class LoginView : Window
    {
        ...
        private void btnLogIn_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            string sql = this.MainVM.CoreBranch.MainDbBranch.RequestPreproc.GetSqlRequestFromFile("Sqlite/App/UpdateSettingsDb.sql"); 
            ...
            this.MainVM.CoreBranch.MainDbBranch.RequestPreproc.SendSqlRequestA(sql); 
            this.MainVM.InitAppRepository(); 
            this.MainVM.Translate(); 
