...
- **`pg-security-db`**: Хранит пользователей, роли и разрешения для сервиса **Security**.
- **`pg-metadata-db`**: Хранит конфигурации источников данных и абстракции подключений.
- **`pg-query-db`**: Хранит историю запросов и логи выполнения.
...
- **Имя источника данных по умолчанию:** `[DataSource Name="sandbox"]`
