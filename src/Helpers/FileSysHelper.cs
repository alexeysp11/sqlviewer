...
namespace SqlViewer.Helpers
{
    public class ConfigHelper
    {
        ...
        public ConfigHelper SetRootFolder(string rootFolder)
        {
        ...
        private void CreateLocalDbIfNotExists(string localDbPath, string sqlScriptPath)
        {
            ...
            {
                string sql = this.MainVM.DbVM.GetSqlRequest(sqlScriptPath); 
                this.MainVM.DbVM.AppDbConnection.ExecuteSqlCommand(sql); 
            }
        }
        ...
        private void CreateShortcutOnDesktop()
        {
            ...
            if ( !(System.IO.File.Exists(shortcutPath)) )
            {
                ...
                if (fDesktopShortcut == null || fDesktopShortcut == 1)
                {
                    ...
                    MainVM.DbVM.AppDbConnection.ExecuteSqlCommand(sql); 
                }
            }
        }
