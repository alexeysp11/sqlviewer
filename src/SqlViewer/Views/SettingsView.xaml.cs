...
public partial class SettingsView : Window
{
    ...
    private void InitPreferencesEditor()
    {
        ...
        cbFontSize.Text = Models.EnumOperations.EnumDecoder.GetFontSizeName(RepoHelper.AppSettingsRepo.FontSize);
        ...
        cbTabSize.Text = Models.EnumOperations.EnumDecoder.GetTabSizeName(RepoHelper.AppSettingsRepo.TabSize);
